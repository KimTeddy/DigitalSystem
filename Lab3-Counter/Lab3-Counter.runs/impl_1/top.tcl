...
namespace eval ::optrace {
  variable script "C:/Xilinx/DigitalSystem/Lab3-Counter/Lab3-Counter.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/Xilinx/DigitalSystem/Lab3-Counter/Lab3-Counter.runs/synth_1/top.dcp
