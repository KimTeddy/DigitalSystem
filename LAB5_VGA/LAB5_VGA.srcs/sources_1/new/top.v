...
module top(input clk_100mhz,input reset_poweron,input [1:0] btn, inout [7:0] key_io,output [3:0] red,output [3:0] green,output [3:0] blue,output vsync,output hsync);
wire clk, rst, locked;  
wire [9:0] x, y; 
wire [2:0] rgb;
wire video_on; 
