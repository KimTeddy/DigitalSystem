...
HD_PWD='C:/Xilinx/DigitalSystem/Homework1-CLA/Homework1-CLA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cla16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cla16.tcl -notrace
