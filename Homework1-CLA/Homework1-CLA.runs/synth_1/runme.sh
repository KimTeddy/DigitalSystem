...
HD_PWD='C:/Xilinx/DigitalSystem/Homework1-CLA/Homework1-CLA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cla16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cla16.tcl
