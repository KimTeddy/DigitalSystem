...
#
# Generated by export_simulation on Thu Nov 09 11:55:20 +0900 2023
#
################################################################################
...
'-reset_run' switch to the './bram8x8.sh' script.

./bram8x8.sh -reset_run
...
./bram8x8.sh -noclean_files

For more information on the script, please type './bram8x8.sh -help'.
