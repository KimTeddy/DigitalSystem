...
HD_PWD='C:/Xilinx/DigitalSystem/LAB1/LAB1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nand_gate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nand_gate.tcl -notrace
