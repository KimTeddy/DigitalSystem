...
HD_PWD='C:/Xilinx/DigitalSystem/LAB1/LAB1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nand_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nand_gate.tcl
